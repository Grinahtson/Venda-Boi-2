...
function createProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var stripe, freeProduct, basicProduct, basicPrice, premiumProduct, premiumPrice;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getUncachableStripeClient()];
                case 1:
                    stripe = _a.sent();
